...
const TIMEZONES = [
    ...
    { value: 'America/New_York', label: 'Eastern Time (ET)', description: 'New York, Miami' },
    { value: 'America/Chicago', label: 'Central Time (CT)', description: 'Chicago, Dallas' },
    { value: 'America/Denver', label: 'Mountain Time (MT)', description: 'Denver, Phoenix' },
    { value: 'America/Los_Angeles', label: 'Pacific Time (PT)', description: 'Los Angeles, Seattle' },
    { value: 'Europe/London', label: 'London (GMT)', description: 'London, Dublin' },
    { value: 'Europe/Paris', label: 'Paris (CET)', description: 'Paris, Berlin' },
    { value: 'Europe/Berlin', label: 'Berlin (CET)', description: 'Berlin, Amsterdam' },
    { value: 'Asia/Tokyo', label: 'Tokyo (JST)', description: 'Tokyo, Seoul' },
    { value: 'Asia/Shanghai', label: 'Shanghai (CST)', description: 'Shanghai, Beijing' },
    { value: 'Australia/Sydney', label: 'Sydney (AEST)', description: 'Sydney, Melbourne' },
]
