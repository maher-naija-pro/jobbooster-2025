...
import { newPassword } from "@/app/(auth)/new-password/_actions"
import { NewPasswordSchema } from "@/app/(auth)/new-password/_schemas"
...
export const NewPasswordFormcom = () => {
  ...
  return (
    <>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="min-h-64 space-y-6">
